...
When Orbits arrive, the same `<BitHost id="..."/>` mount used by the standalone pages in
`web/` will embed interactive Bits; video/figure/document Bits will be embedded through
their declared `dist/` outputs. See `docs/architecture.md`.
